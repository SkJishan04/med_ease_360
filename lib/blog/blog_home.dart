...
import 'package:mineapp/blog/blog1info.dart';
import 'package:mineapp/blog/blog2info.dart';
import 'package:mineapp/blog/blog3info.dart';
void main() {
  runApp(DoctorBlogpage());
}
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: Text("Hi, Dr Suresh Mishra", style: TextStyle(fontSize: 28,
          ...
          Container(
            ...
            child: Text("Upload your new Vlog", style: TextStyle(fontSize: 18)),
          )
          ),],),),
          SizedBox(height: 16,),
          Row(
          ...
          Container(
            ...
            child: ListView(
              ...
              children: [
                ...
                child:DecoratedBlogCard(imageUrl: "assets/images/blog2.jpg", blogName: "Life Chornicles",likes:"Likes :1k+",per: "Dr Alex"),
                   ),
                  InkWell(
                  onTap: () {
                    Navigator.push(
                ...
                child:DecoratedBlogCard(imageUrl: "assets/images/blog4.jpg", blogName: "The Cardiac Action",likes:"Likes:1.5k+",per :"Dr Shubham"),
                  ),
